 ...
 */
function otzi_lite_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 * @since  Otzi 1.0.0
 */
function otzi_lite_sanitize_custom_css( $input ) {
	if ( '' != $input  ) {
 ...
 */
function otzi_lite_sanitize_image( $image, $setting ) {
	/*
 ...
 */
function otzi_lite_sanitize_page( $input ) {
 ...
 * @since Otzi Lite 0.1
 */
function otzi_lite_sanitize_category_list( $input ) {
	if ( '' != $input  ) {
		$args = array(
						'type'			=> 'post',
						'child_of'      => 0,
 ...
 *                    the setting default.
 */
function otzi_lite_sanitize_number_range( $number, $setting ) {
 ...
 */
function otzi_lite_sanitize_select( $input, $setting ) {
